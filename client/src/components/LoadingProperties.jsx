...
const LoadingProperties = () => {
  return (
    <div className="max-w-sm p-4 border border-white-200 rounded shadow animate-pulse md:p-6 dark:border-gray-400">
      ...
      <div className="flex items-center mt-4">
        <div>
          <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-400 w-64 mb-2"></div>
          <div className="w-64 h-2 bg-gray-200 rounded-full dark:bg-gray-400"></div>
        </div>
      </div>
    </div>
  );
